...
/** Identificadores de domínio fortemente tipados. */
...
/** Entidades centrais do domínio eleitoral. */
...
/** Erros de negócio possíveis nas operações do domínio. */
...
/** Eventos de auditoria publicados ao longo do ciclo de votação. */
